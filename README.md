...
<!-- <div class="equation" align="center" data-raw-text="y = \log_b(x) \quad \text{such that} \quad b^y = x" data-equation="eq:logarithm">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@85f48534ef6908bbcd982d48f1c5fbea3fb7aafd/lib/node_modules/@stdlib/math/base/special/logf/docs/img/equation_logarithm.svg" alt="Logarithm with arbitrary base">
    <br>
</div> -->
